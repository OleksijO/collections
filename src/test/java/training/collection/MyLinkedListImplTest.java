...
public class MyLinkedListImplTest {
    ...
    private List<Integer> listWithThreeElements = new MyLinkedListImpl<>();
    private List<Integer> listWithThreeElementsOneIsNull = new MyLinkedListImpl<>();
    private List<Integer> listWithOneNullElement = new MyLinkedListImpl<>();
    ...
    @Before
    public void init() {
        emptyList = new MyLinkedListImpl<>();
    ...
    public void testListIteratorMustBeConcurrentException() throws Exception {
        List<Integer> arrayList = new MyLinkedListImpl<>();
        arrayList.add(1);
        arrayList.add(2);
        arrayList.add(3);
        arrayList.add(4);
